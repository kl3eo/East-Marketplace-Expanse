...
export default function NFTCard ({ nft, action, updateNFT, onCliCliCli }) {
  ...
  museoReal = Museo === 'artsmia' ? 'Minneapolis Inst. of Art' : museoReal // open access on PD https://new.artsmia.org/copyright-and-image-access
  ...
  museoReal = Museo === 'yaleartgallery' ? 'Yale Art Gallery, New Haven' : museoReal // open access https://artgallery.yale.edu/using-collection
  ...
  museoReal = Museo === 'jewishmuseum' ? 'The Jewish Museum, New York' : museoReal // hi-res and dnld button, only for PD
