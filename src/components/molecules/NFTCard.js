...
export default function NFTCard ({ nft, action, updateNFT, onCliCliCli }) {
  ...
  museoReal = Museo === 'smkmuseum' ? 'SMK, Copenhagen' : museoReal // CC-PDM https://www.smk.dk/en/article/about-smk-open/
