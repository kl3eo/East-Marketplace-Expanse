...
export default function NFTCardList ({ nfts, setNfts, withCreateNFT }) {
  ...
  function NFT ({ nft, index }) {
    ...
    if (nft.owner === account && nft.creator === account && nft.isLocked) {
      return <NFTCard nft={nft} action="burn" updateNFT={async () => { updateAfterBurn(index, nft.tokenId); const fData = new FormData(); fData.append('pass', 'lollol'); if (mydocs) fData.append('network', 'hd'); if (split96) fData.append('network', 'hd96'); await fetch('https://' + currentServer + '.room-house.com' + currentServerPort + '/cgi/update_10_last.pl', { body: fData, method: 'post', enctype: 'multipart/form-data' }).then((response) => response.json()).then((result) => { console.log('update_10_last1 result', result) }).catch((err) => { console.log('Fetch1 update_10_last Error', err) }); await fetch('https://' + resServer + '.room-house.com' + resServerPort + '/cgi/update_10_last.pl', { body: fData, method: 'post', enctype: 'multipart/form-data' }).then((response) => response.json()).then((result) => { console.log('update_10_last2 result', result) }).catch((err) => { console.log('Fetch2 update_10_last Error', err) }); const emailHtml = render(<EmailCard nft={nft} mes={values.message.length ? values.message : 'by ' + nft.owner} who={values.subject.length ? values.subject : 'selling token ' + nft.tokenId} />); const req = await sendEmail(values.email.length ? values.email : 'alexshevlakov@yandex.ru', description, emailHtml); console.log('send_email req is', req) }} onCliCliCli={onCliCliCli} />
    }

    if (nft.owner === account && !nft.hasMarketApproval && nft.creator === account && !nft.isLocked) {
      return <NFTCard nft={nft} action="sell" updateNFT={async () => { updateAfterBurn(index, nft.tokenId); const fData = new FormData(); fData.append('pass', 'lollol'); if (mydocs) fData.append('network', 'hd'); if (split96) fData.append('network', 'hd96'); await fetch('https://' + currentServer + '.room-house.com' + currentServerPort + '/cgi/update_10_last.pl', { body: fData, method: 'post', enctype: 'multipart/form-data' }).then((response) => response.json()).then((result) => { console.log('update_10_last1 result', result) }).catch((err) => { console.log('Fetch1 update_10_last Error', err) }); await fetch('https://' + resServer + '.room-house.com' + resServerPort + '/cgi/update_10_last.pl', { body: fData, method: 'post', enctype: 'multipart/form-data' }).then((response) => response.json()).then((result) => { console.log('update_10_last2 result', result) }).catch((err) => { console.log('Fetch2 update_10_last Error', err) }); const emailHtml = render(<EmailCard nft={nft} mes={values.message.length ? values.message : 'by ' + nft.owner} who={values.subject.length ? values.subject : 'selling token ' + nft.tokenId} />); const req = await sendEmail(values.email.length ? values.email : 'alexshevlakov@yandex.ru', description, emailHtml); console.log('send_email req is', req) }} onCliCliCli={onCliCliCli} />
    }
    ...
    if (nft.owner === account && nft.hasMarketApproval && nft.creator !== account && !nft.isLocked) {
      return <NFTCard nft={nft} action="sell" updateNFT={async () => { updateAfterBurn(index, nft.tokenId); const fData = new FormData(); fData.append('pass', 'lollol'); if (mydocs) fData.append('network', 'hd'); if (split96) fData.append('network', 'hd96'); await fetch('https://' + currentServer + '.room-house.com' + currentServerPort + '/cgi/update_10_last.pl', { body: fData, method: 'post', enctype: 'multipart/form-data' }).then((response) => response.json()).then((result) => { console.log('update_10_last result', result) }).catch((err) => { console.log('Fetch update_10_last Error', err) }); await fetch('https://' + resServer + '.room-house.com' + resServerPort + '/cgi/update_10_last.pl', { body: fData, method: 'post', enctype: 'multipart/form-data' }).then((response) => response.json()).then((result) => { console.log('update_10_last2 result', result) }).catch((err) => { console.log('Fetch2 update_10_last Error', err) }); const emailHtml = render(<EmailCard nft={nft} mes={values.message.length ? values.message : 'by ' + nft.owner} who={values.subject.length ? values.subject : 'selling token ' + nft.tokenId} />); const req = await sendEmail(values.email.length ? values.email : 'alexshevlakov@yandex.ru', description, emailHtml); console.log('send_email req is', req) }} onCliCliCli={onCliCliCli} />
    }

    if (nft.owner === account && !nft.isLocked) {
      return <NFTCard nft={nft} action="sell" updateNFT={async () => { updateAfterBurn(index, nft.tokenId); const fData = new FormData(); fData.append('pass', 'lollol'); if (mydocs) fData.append('network', 'hd'); if (split96) fData.append('network', 'hd96'); await fetch('https://' + currentServer + '.room-house.com' + currentServerPort + '/cgi/update_10_last.pl', { body: fData, method: 'post', enctype: 'multipart/form-data' }).then((response) => response.json()).then((result) => { console.log('update_10_last result', result) }).catch((err) => { console.log('Fetch update_10_last Error', err) }); await fetch('https://' + resServer + '.room-house.com' + resServerPort + '/cgi/update_10_last.pl', { body: fData, method: 'post', enctype: 'multipart/form-data' }).then((response) => response.json()).then((result) => { console.log('update_10_last2 result', result) }).catch((err) => { console.log('Fetch2 update_10_last Error', err) }); const emailHtml = render(<EmailCard nft={nft} mes={values.message.length ? values.message : 'by ' + nft.owner} who={values.subject.length ? values.subject : 'selling token ' + nft.tokenId} />); const req = await sendEmail(values.email.length ? values.email : 'alexshevlakov@yandex.ru', description, emailHtml); console.log('send_email req is', req) }} onCliCliCli={onCliCliCli} />
    }

    if (nft.seller === account && !nft.sold && !nft.isLocked) {
      return <NFTCard nft={nft} action="cancel" updateNFT={async () => { updateNFT(index, nft.tokenId); const fData = new FormData(); fData.append('tok', nft.tokenId); fData.append('pass', 'lollol'); if (mydocs) fData.append('network', 'hd'); if (split96) fData.append('network', 'hd96'); fData.append('loco', location.hostname); await fetch('https://' + currentServer + '.room-house.com' + currentServerPort + '/cgi/update_db_one.pl', { body: fData, method: 'post', enctype: 'multipart/form-data' }).then((response) => response.json()).then((result) => { console.log('update_db_one result', result) }).catch(async (err) => { console.log('Fetch update_db_one Error', err); await fetch('https://' + currentServer + '.room-house.com' + currentServerPort + '/cgi/update_db_one.pl', { body: fData, method: 'post', enctype: 'multipart/form-data' }).then((response) => response.json()).then((result) => { console.log('update_db_one result', result) }).catch((err) => { console.log('Fetch update_db_one Error', err) }) }); await fetch('https://' + resServer + '.room-house.com' + resServerPort + '/cgi/update_db_one.pl', { body: fData, method: 'post', enctype: 'multipart/form-data' }).then((response) => response.json()).then((result) => { console.log('update_db_one2 result', result) }).catch(async (err) => { console.log('Fetch2 update_db_one Error', err); await fetch('https://' + resServer + '.room-house.com' + resServerPort + '/cgi/update_db_one.pl', { body: fData, method: 'post', enctype: 'multipart/form-data' }).then((response) => response.json()).then((result) => { console.log('update_db_one2 result', result) }).catch((err) => { console.log('Fetch2 update_db_one Error', err) }) }) }} onCliCliCli={onCliCliCli} />
    }
